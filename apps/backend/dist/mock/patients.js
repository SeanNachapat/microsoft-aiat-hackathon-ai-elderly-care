...
exports.updatePatientVitals = exports.getPatientById = exports.patientsStore = exports.mockPatients = void 0;
...
exports.patientsStore = JSON.parse(JSON.stringify(exports.mockPatients));
const getPatientById = (id) => exports.patientsStore.find((p) => p.id === id);
exports.getPatientById = getPatientById;
const updatePatientVitals = (id, vitals) => {
    const patient = exports.patientsStore.find((p) => p.id === id);
    if (!patient)
        return undefined;
    ...
    if (vitals.bp)
        patient.bp = vitals.bp;
    patient.lastUpdated = new Date().toISOString();
    return patient;
};
exports.updatePatientVitals = updatePatientVitals;
