...
exports.nurseJiraConfigTH = void 0;
exports.nurseJiraConfigTH = {
    // ─────────────────────────────────────────
    ...
    // ─────────────────────────────────────────
    alerts: {
        lonelinessMessage: (elderName, contactName) => `สวัสดีคุณ ${contactName} — คุณ${elderName}คิดถึงคุณมากค่ะ ` +
            `ยังไม่ได้รับสายจากคุณหลายวันแล้ว โทรหาท่านสักครู่ได้เลยนะคะ — CareCompanion`,
        missedMedMessage: (elderName, medName, contactName) => `แจ้งเตือน: คุณ${elderName}ยังไม่ได้รับประทาน ${medName} ตามเวลาที่กำหนดค่ะ ` +
            `กรุณาติดต่อท่านเพื่อเตือนด้วยนะคะ — CareCompanion`,
        emergencyMessage: (elderName, contactName) => `🚨 ฉุกเฉิน — คุณ${elderName}ต้องการความช่วยเหลือทันทีค่ะ ` +
            `กรุณาโทรหาท่านหรือส่งใครไปดูแลโดยด่วนค่ะ — CareCompanion`,
        dailyReportSubject: (elderName, date) => `รายงานประจำวัน — คุณ${elderName} — ${date}`,
    },
    // ─────────────────────────────────────────
    // GREETING LINES
    // ─────────────────────────────────────────
    greetings: {
        positive: (preferredName, timeOfDay) => `${timeOfDay}ค่ะ คุณ${preferredName}! ดีใจที่ได้คุยด้วยค่ะ วันนี้รู้สึกเป็นอย่างไรบ้างคะ?`,
        lowMood: (preferredName) => `สวัสดีค่ะ คุณ${preferredName} หนูคิดถึงคุณนะคะ วันนี้เป็นอย่างไรบ้างคะ?`,
        firstSession: (preferredName) => `สวัสดีค่ะ คุณ${preferredName}! หนูชื่อ Nurse Jira ค่ะ จะอยู่เป็นเพื่อนคุณทุกเมื่อที่อยากคุยนะคะ ตอนนี้รู้สึกเป็นอย่างไรบ้างคะ?`,
    },
    // ─────────────────────────────────────────
    // ESCALATION PHRASES
    // ─────────────────────────────────────────
    escalation: {
        level4Emergency: (preferredName) => `คุณ${preferredName}คะ หนูกำลังส่งคนมาช่วยทันทีเลยนะคะ กรุณาอยู่ที่เดิมก่อนนะคะ ความช่วยเหลือกำลังมาค่ะ`,
    },
    // ─────────────────────────────────────────
...
//# sourceMappingURL=nurseJira.config.th.js.map