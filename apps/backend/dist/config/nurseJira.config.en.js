...
exports.nurseJiraConfigEN = void 0;
exports.nurseJiraConfigEN = {
    // ─────────────────────────────────────────
    ...
    // ─────────────────────────────────────────
    alerts: {
        lonelinessMessage: (elderName, contactName) => `Hi ${contactName} — ${elderName} misses you. ` +
            `They haven't heard from you in a few days. Give them a quick call! — CareCompanion`,
        missedMedMessage: (elderName, medName, contactName) => `Alert: ${elderName} missed their ${medName} on schedule. ` +
            `Please contact them to check in. — CareCompanion`,
        emergencyMessage: (elderName, contactName) => `🚨 EMERGENCY — ${elderName} needs immediate assistance. ` +
            `Please call them or send help right away. — CareCompanion`,
        dailyReportSubject: (elderName, date) => `Daily Report — ${elderName} — ${date}`,
    },
    // ─────────────────────────────────────────
    // GREETING LINES — spoken by Nurse Jira
    // ─────────────────────────────────────────
    greetings: {
        positive: (preferredName, timeOfDay) => `Good ${timeOfDay}, ${preferredName}! ` +
            `It's so good to hear your voice. How are you feeling today?`,
        lowMood: (preferredName) => `Hello, ${preferredName}. ` +
            `I was thinking about you. How are you doing today?`,
        firstSession: (preferredName) => `Hello, ${preferredName}! ` +
    ...
    // ─────────────────────────────────────────
    escalation: {
        level4Emergency: (preferredName) => `I'm sending help to you right now, ${preferredName}. ` +
...
//# sourceMappingURL=nurseJira.config.en.js.map