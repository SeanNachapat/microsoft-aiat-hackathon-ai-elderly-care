...
export default function ActivityPage() {
  const activities = [
    { title: 'Morning Walk', time: '07:30', duration: '20 min', status: 'completed' },
    { title: 'Arm Physical Therapy', time: '10:00', duration: '15 min', status: 'completed' },
    { title: 'Evening Stretch', time: '20:00', duration: '10 min', status: 'pending' },
  ];

  return (
    <div className="flex flex-col px-5 pb-8">
      <SubPageHeader titleEn="Physical Activity" />
      ...
      <div className="bg-white rounded-[32px] p-8 border border-gray-100 shadow-sm flex flex-col items-center mb-8 relative overflow-hidden">
        ...
        <span className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-2">Steps Today</span>
        ...
        <div className="grid grid-cols-2 w-full mt-8 gap-4 border-t border-gray-50 pt-6">
          ...
          <div className="flex flex-col items-center border-l border-gray-50">
            <span className="text-[10px] font-bold text-gray-400 uppercase">Active Time</span>
      ...
      <h3 className="text-[18px] font-black text-gray-800 mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>Today's Plan</h3>
          ...
          <div key={i} className="bg-white rounded-[24px] p-5 border border-gray-100 shadow-sm flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col">
                <h4 className="text-[15px] font-black text-gray-800 leading-tight" style={{ fontFamily: "'Playfair Display', serif" }}>{a.title}</h4>
